...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
    ...
    $html_msg['PRODUCTS_DETAIL']='<table class="product-details" width="100%" cellpadding="2">' . $this->products_ordered_html . '</table>';
    ...
    $html_msg['ORDER_TOTALS'] = '<table width="100%" cellpadding="2"> ' . $html_ot . ' </table>';
